...
const run = () => {
    ...
    const actionInputs = {
        projectPath: core.getInput('project', {required: true}),
        ignore: core.getInput('ignore', {required: false}),
        configFilePath: core.getInput('config-file-path', {required: false}),
    };

    const horusec = getHorusec();
